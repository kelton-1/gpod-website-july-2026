#!/bin/zsh
# Deploy the cart-drawer interior redesign (commit 0effd5c — includes the
# nested-form fix) to the DRAFT theme "GPOD GOLF -July 2026-Repo"
# (154401538216). Does NOT touch live.
# Files come from the pinned GitHub commit, so what deploys = what was reviewed.
export PATH="/Users/kelton1/.local/bin:$PATH"
SHA=0effd5ca3876442f40d3928a43e95d38b6bec74f
